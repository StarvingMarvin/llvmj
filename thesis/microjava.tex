...
\begin{description}
   ...
   \item[Ulaz i izlaz] \hfill \\
	...
	\item[Tipovi] \hfill \\
	Konstante se deklarišu modifikatorom \mj{final} koji je moguće primeniti na tipove \mj{int} i \mj{char}. Metode bez povratne vrednosti imaju tip \mj{void}. Korisnički tipovi se deklarišu sa \mj{class}, a zajedno sa nizovima instanciraju sa \mj{new}.
